    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <router-link class="nav-link me-2" to="/billing">
              <i
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a
              ...
              :class="isBlur ? 'bg-gradient-dark' : 'bg-gradient-info'"
              >Free download</a
            >
          </li>
        </ul>
...
export default {
  ...
  computed: {
    ...
    navbar(): boolean {
      return store.state.app.showNavbar;
    },
  },
};
</script>
